...
//                     <Link to="/chat" className="text-gray-700 text-center bg-gray-400 px-4 py-2 m-2">Messages</Link>
//                     <Link to="/home" className="text-gray-700 text-center bg-gray-400 px-4 py-2 m-2">Home</Link>
//                     <Link to={`/dashboard/${loggedInUser?._id}`} className="text-gray-700 text-center bg-gray-400 px-4 py-2 m-2">Dashboard</Link>
//                 </div>
//             </div>
    ...
    return (
        <div className="relative bg-blue-500">
            <div className="w-screen flex flex-row items-center p-1 justify-between bg-blue-600 shadow-xs">
                <div className="ml-8 text-lg text-gray-700 hidden md:flex bg-blue-200 rounded-md">My Website</div>
                {isLogged && <>
                    <span className="w-screen md:w-1/3 h-10 bg-gray-200 cursor-pointer border border-gray-300 text-sm rounded-full flex">
                    <input
                        type="search"
