    ...
    return (
        <div className={`w-full h-screen p-4 flex flex-col ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-100'}`}>
            ...
            <div className="flex-grow flex flex-col">
                ...
                <div className="flex mt-4 space-x-4" style={{ height: '30%' }}>
                    ...
                    <div className={`w-1/2 p-2 ${theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-white text-black'} rounded resize-y overflow-auto`}>
                        ...
                        <button onClick={handleCopyInput} className="p-2 bg-gray-200 rounded">
                        <BiCopy />
                    </button>
                        <textarea
                            value={customInput}
                    ...
                    <div className={`w-1/2 p-2 ${theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-white text-black'} rounded resize-y overflow-auto`}>
                        ...
                        <button onClick={handleCopyOutput} className="p-2 bg-gray-200 rounded">
                        <BiCopy />
                        </button>
                        <pre>{output}</pre>
                    </div>
